    ...
    return (
        ...
        <div className="mx-auto max-w-6xl py-8 px-4">
            <div className="space-y-4 py-2">
                ...
                <p className="text-primary">This Privacy Policy outlines our policies and procedures regarding the collection, use, and disclosure of your information when you use our Service. It also informs you of your privacy rights and how the law protects you.</p>
            </div>
            <div className="space-y-4 py-2">
                ...
                <h5 className="text-primary text-lg font-semibold">Personal Data</h5>
                <div className="space-y-4">
                    <p className="text-primary">While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information may include, but is not limited to:
                    </p>
                    <ul className="px-4 text-primary space-y-4">
            ...
            <div className="space-y-4 py-2">
                ...
                <p className="text-primary space-y-4 py-2">
